...
async function initDB() {
  ...
  try {
    ...
    await client.query(`ALTER TABLE users      ADD COLUMN IF NOT EXISTS nik_number      TEXT;`);
    await client.query(`ALTER TABLE users      ADD COLUMN IF NOT EXISTS passport_id     TEXT;`);
    ...
    await client.query(`ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS payment_notes             TEXT;`);
    await client.query(`ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS payment_attachment_name   TEXT;`);
    await client.query(`ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS payment_attachment_data   BYTEA;`);
